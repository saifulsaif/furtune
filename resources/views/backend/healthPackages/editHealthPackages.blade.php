...
<div class="panel panel-default">
    <div class="panel-body" style="padding:20px 0px 0px 0px">
            ...
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <input type="hidden" name="id" id="{{$package->id}}" value="{{$package->id}}">
                    <div class="form-group header-group-0 " id="form-group-package_name" style="">
                        ...
                        <div class="col-sm-10">
                        <input type="text" title="Package Name" required="" maxlength="255" class="form-control" name="package_name" id="package_name" value="{{$package->package_name}}">
                    ...
                    <div class="form-group header-group-0 " id="form-group-rate" style="">
                        ...
                        <div class="col-sm-10">
                            <input type="text" title="Rate" required="" maxlength="255" class="form-control" name="rate" id="rate" value="{{$package->rate}}">
                            <div class="text-danger"></div>
                            <p class="help-block"></p>
                        </div>
                    </div>
                    @if (!empty($services))
                        @foreach ($services as $item)
                            <div class="form-group header-group-0 rem" id="form-group-rate" style="">
                                ...
                                <div class="col-sm-8">
                                <input type="text" title="service" required="" maxlength="255" class="form-control" name="service[]" id="rate" value="{{$item->service_name}}">
                                    <div class="text-danger"></div>
                                    <p class="help-block"></p>
                                </div>
                                <div class="col-sm-2">
                                    <div class="btnR"></div>
                                <input type="button" title="Rate"  maxlength="255" class="form-control btn btn-danger" onclick="deleteid({{$item->id}})" id="del" value="Delete">
                                    <div class="text-danger"></div>
                                    <p class="help-block"></p>
                                </div>
                            </div>

<?php namespace App\Http\Controllers;
	...
	class AdminListAppointmentsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"DiseaseTopic","name"=>"diseaseTopic"];

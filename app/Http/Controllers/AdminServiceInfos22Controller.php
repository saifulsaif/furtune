<?php namespace App\Http\Controllers;
	...
	class AdminServiceInfos22Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Menu List Id","name"=>"menu_list_id","join"=>"sub_menu_lists,id"];
			...
			$this->form[] = ['label'=>'Menu List Id','name'=>'menu_list_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'sub_menu_lists,id'];

<?php namespace App\Http\Controllers;
	...
	class AdminHealthPackagesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Hover Image","name"=>"hover_image"];
			...
			$this->form[] = ['label'=>'Hover Image','name'=>'hover_image','type'=>'upload','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Hover Image","name"=>"hover_image","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM

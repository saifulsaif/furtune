<?php namespace App\Http\Controllers;
	...
	class AdminExpertTeamController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Specialization","name"=>"specialization"];
			$this->col[] = ["label"=>"Intertest","name"=>"intertest"];
			...
			$this->form[] = ['label'=>'Intertest','name'=>'intertest','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Descreption','name'=>'descreption','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Intertest","name"=>"intertest","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Descreption","name"=>"descreption","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			# OLD END FORM
